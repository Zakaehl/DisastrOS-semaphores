...
#define DSOS_ESEM_NEG_INIT -14
#define DSOS_ESEM_ALLOC -15
#define DSOS_ESEM_FD_ALLOC -16
#define DSOS_ESEM_FD_PTR_ALLOC -17
#define DSOS_ESEM_NO_SEM -18
#define DSOS_ESEM_NO_FD -19
#define DSOS_ESEM_NO_FD_PTR -20
